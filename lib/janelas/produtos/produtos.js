...
import { StyleSheet, ActivityIndicator, Text, View, TouchableOpacity, TextInput } from 'react-native';
import PlanoComponnent from './plano_componnent';
import { getPlanos, setPlanosController } from './planos_controller';
        ...
        <View style={styles.viewForm}>
          ...
          <TouchableOpacity
            onPress={() => {
              ...
              setPreco("");
              setDescricao([]);
              setPlanosController(dados, setPlanos, isLoading);
            }}
